...
public class CommonPopWindow {
    ...
    public interface ViewClickListener {
        void getChildView(PopupWindow mPopupWindow, View view, int mLayoutResId, TextView textView);
    }
    ...
    public static class Builder implements PopupWindow.OnDismissListener {
        ...
        public CommonPopWindow build(Context context) {
            ...
            if (mListener != null && mLayoutResId != 0) {
                mListener.getChildView(mPopupWindow, mContentView, mLayoutResId,mTextView);
            }
            return popWindow;
        }
